(self.webpackChunk = self.webpackChunk || []).push([
    ["640"], {
        5487: function() {
            ...
            window.tram = function(e) {
                ...
                N.transform && ($.transform = [U], Y = {
                    ...
                    skewX: [v],
                    skewY: [v]
                }), N.transform && N.backface && (Y.z = [I, "translateZ"], Y.rotateZ = [v], Y.scaleZ = [m], Y.perspective = [_]);
                var q = /ms/,
                    Q = /s|\./;
                return e.tram = t
            }(window.jQuery)
        ...
        5756: function(e, t, n) {
            "use strict";
            var i, r, a, o, u, c, s, l, f, d, p, E, g, h, m, y, _, I, v, T, b = window.$,
                O = n(5487) && b.tram;
            e.exports = ((i = {}).VERSION = "1.6.0-Webflow", r = {}, a = Array.prototype, o = Object.prototype, u = Function.prototype, a.push, c = a.slice, s = (a.concat, o.toString, o.hasOwnProperty), l = a.forEach, f = a.map, d = (a.reduce, a.reduceRight, a.filter), p = (a.every, a.some), E = a.indexOf, g = (a.lastIndexOf, Object.keys), u.bind, h = i.each = i.forEach = function(e, t, n) {
                ...
                e.replace(a, function(t, n, i, r, a) {
                    return u += e.slice(o, a).replace(I, v), o = a + t.length, n ? u += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : i ? u += "'+\n((__t=(" + i + "))==null?'':__t)+\n'" : r && (u += "';\n" + r + "\n__p+='"), t
                }), u += "';\n";
                var c = t.variable;
                if (c) {
        ...
        3949: function(e, t, n) {
            ...
            var _ = navigator.userAgent.toLowerCase(),
                ...
                v = a.env.chrome = /chrome/.test(_) && /Google/.test(navigator.vendor) && parseInt(_.match(/chrome\/(\d+)\./)[1], 10),
                T = a.env.ios = /(ipod|iphone|ipad)/.test(_);
            a.env.safari = /safari/.test(_) && !v && !T, I && f.on("touchstart mousedown", function(e) {
                i = e.target
            ...
            a.resize = w(l, b), a.scroll = w(l, O), a.redraw = w(), a.location = function(e) {
                window.location = e
        ...
        9858: function(e, t, n) {
            ...
            i.define("dropdown", e.exports = function(e, t) {
                ...
                function w() {
                    n = l && i.env("design"), (u = O.find(p)).each(A)
                }
                ...
                function A(t, r) {
                    ...
                    !s && (s = e.data(r, p, {
                        ...
                        return t.mouseUpOutside && O.off(v, t.mouseUpOutside), c(function(n) {
                            if (!t.open) return;
                            var r = e(n.target);
                    ...
                    }(s)), s.toggle.on(v, g), s.toggle.on(m, function(e) {
                        var t = C(e, !0);
                        return function(i) {
                            if (!n) {
                ...
                function N(t) {
                    if (!t.open) {
                        ...
                        var r = i.env("editor");
                        !n && O.on(v, t.mouseUpOutside), t.hovering && !r && t.el.on(I, t.mouseLeave), t.hovering && r && O.on(_, t.mouseMoveOutside), window.clearTimeout(t.delayId)
                    }
                }
                ...
                function S(e, {
                    ...
                    if (!!e.open && (!e.config.hover || !e.hovering || !!n)) {
                        ...
                        var i = e.config;
                        if (g.outro(0, e.el[0]), O.off(v, e.mouseUpOutside), O.off(_, e.mouseMoveOutside), e.el.off(I, e.mouseLeave), window.clearTimeout(e.delayId), !i.delay || t) return e.complete();
        ...
        1970: function(e, t, n) {
            ...
            function Z(e, t) {
                ...
                if (et({
                        ...
                        allowEvents: o,
                        testManual: c
                    }), i && n === f.ActionTypeConsts.GENERAL_START_ACTION || _(n)) {
                    ef({
                        store: t,
                        actionListId: i
                    }), es({
                            ...
                            ea(e), (0, s.default)(n, (t, n) => {
                                ...
                                if (!o) {
                                    ...
                                    (0, s.default)(g, (e, a) => {
                                        ...
                                        !B(l, c.mediaQueryKeys) && t.dispatch((0, p.mediaQueriesDefined)()), u.actionTypeId === f.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION && (Array.isArray(o.config) ? o.config : [o.config]).forEach(n => {
                                            ...
                                            if (!!u) e.forEach((e, i) => {
                                                ! function({
                                                    ...
                                                    x(h, a) && (b = k(t, b));
                                                    let O = d.hasBoundaryNodes && n ? E.getClosestElement(n, v) : null;
                                                    T.forEach(e => {
                                                        let {
                                                            keyframe: t,
                                                            actionItems: i
                                        ...
                                        }), (u.actionTypeId === f.ActionTypeConsts.GENERAL_START_ACTION || _(u.actionTypeId)) && es({
                                            store: t,
                                            actionListId: g,
                                            eventId: s
                                        })
            ...
            function es({
                ...
                if (s && s.useFirstGroupAsInitialState) {
                    ...
                    if (!G((0, r.default)(c, "mediaQueries", i.mediaQueryKeys), a.mediaQueryKey)) return;
                    o.forEach(i => {
                        let {
                            config: r,
                            actionTypeId: a
            ...
            function ed({
                ...
                let m = (0 === o || 1 === o && h) && _(d.action?.actionTypeId) ? d.config.delay : void 0,
                    y = (0, r.default)(g, [o, "actionItems"], []);
                if (!y.length || !G(p, l.mediaQueryKey)) return !1;
                let I = l.hasBoundaryNodes && n ? E.getClosestElement(n, v) : null,
                    T = F(y),
                    b = !1;
            ...
            function ep(e) {
                ...
                let {
                    ...
                    refState: I
                } = h[_] || {}, v = E.getRefType(a), T = m.reducedMotion && f.ReducedMotionTypes[o.actionTypeId];
                    ...
                    if (i || n || r) {
                        ...
                        if (r) {
                            if (m) {
                                ...
                                _ && !e && t.dispatch((0, p.actionListPlaybackChanged)({
                                    actionListId: h,
                                    isPlaying: !1
                                }))
                            }
                ...
                [C]: {
                    ...
                    handler: ({
                        ...
                        let {
                            ...
                            pageX: g = a.pageX,
                            pageY: h = a.pageY
                        } = i, m = "X_AXIS" === u, y = "mouseout" === i.type, _ = d / 100, I = c, v = !1;
                        switch (o) {
                            case s.EventBasedOn.VIEWPORT:
                                _ = m ? Math.min(p, window.innerWidth) / window.innerWidth : Math.min(E, window.innerHeight) / window.innerHeight;
                                break;
                            case s.EventBasedOn.PAGE: {
                                ...
                                _ = m ? Math.min(e + g, n) / n : Math.min(t + h, i) / i;
                                break
                            }
                        ...
                        return y && (_ > .95 || _ < .05) && (_ = Math.round(_)), (o !== s.EventBasedOn.ELEMENT || v || v !== a.elementHovered) && (_ = l ? 1 - _ : _, e.dispatch((0, f.parameterChanged)(I, _))), {
                            elementHovered: v,
                            clientX: p,
                            clientY: E,
                            pageX: g,
                ...
                [P]: {
                    ...
                    handler: ({
                        ...
                        if (d === s.EventBasedOn.VIEWPORT) {
                            ...
                            return v !== r.scrollPercent && t.dispatch((0, f.parameterChanged)(n, v)), {
                                scrollPercent: v
                            }
                        }
                    }
            ...
            let i = n(7087),
                ...
                _ = (e, t) => {
                    ...
                    let {
                        ...
                        parameters: I
                    } = t.payload, v = Math.max(1 - f, .01), T = I[c];
                    null == T && (v = 1, T = E);
                ...
                I = (e, t) => {
                    ...
                    null != E && (I = E), v = null != h ? h : v, u === g ? I = 0 : (o || y) && (I = v = 0);
                    let {
                        now: T
                    } = t.payload;
                    if (n && i) {
        ...
        4124: function(e, t, n) {
            ...
            function ey({
                ...
                let A = (t?.action?.config?.affectedElements ?? {})[I || T] || {},
                    R = !!(A.id || A.selector),
                    C = t && f(em(t.target));
                if (R ? (a = A.limitAffectedElements, o = C, c = f(A)) : o = c = f({
                        id: I,
                        selector: T,
                        selectorGuids: b
                    }), t && w) {
            ...
            let eI = /px/,
                ...
                eT = (e, t) => t.reduce((e, t) => (null == e[t.type] && (e[t.type] = eP[t.type] || t.defaultValue || 0), e), e || {});
                ...
                switch (r.actionTypeId) {
                    ...
                    case J: {
                        ...
                        return t = r.config.widthUnit === G ? eI.test(u) ? parseFloat(u) : parseFloat(n.width) : (0, i.default)(parseFloat(u), parseFloat(n.width)), {
                            widthValue: t,
                            heightValue: a = r.config.heightUnit === G ? eI.test(c) ? parseFloat(c) : parseFloat(n.height) : (0, i.default)(parseFloat(c), parseFloat(n.height))
                        }
                    }
                    case ee:
                    case et:
                ...
                switch (c) {
                    case B:
                        return function(e, t, n, i, r) {
                            ...
                            eG(e, d.TRANSFORM_PREFIXED, r), o(e, d.TRANSFORM_PREFIXED, a),
                                function({
                                    actionTypeId: e
                                }, {
                                    xValue: t,
                        ...
                        return function(e, t, n, i, a, o) {
                            ...
                            switch (i.actionTypeId) {
                                case J: {
                                    ...
                                    void 0 !== a && (t === G && (t = "px"), eG(e, R, o), u(e, R, a + t)), void 0 !== c && (r === G && (r = "px"), eG(e, C, o), u(e, C, c + r));
                                    break
                                }
                                case K:
                                    ! function(e, t, n, i) {
                                ...
                                case en: {
                                    let t = eo[i.actionTypeId],
                                        ...
                                        s = n.aValue;
                                    eG(e, t, o), u(e, t, s >= 1 ? `rgb(${r},${a},${c})` : `rgba(${r},${a},${c},${s})`);
                                    break
                                }
                                default: {
                                    let {
                    ...
                    case X:
                        return function(e, t, n) {
                            ...
                            if (t.actionTypeId === ei) {
                                ...
                                i(e, x, n === b && d.IS_BROWSER_ENV ? d.FLEX_PREFIXED : n);
                                return
                            }
                        }(e, a, u);
                    case H: {
            ...
            function eG(e, t, n) {
                ...
                let u = o.split(U).map(ea); - 1 === u.indexOf(i) && a(e, k, u.concat(i).join(U))
            }
            ...
            function eU(e, t, n) {
                ...
                if (!!o && -1 !== o.indexOf(i)) a(e, k, o.split(U).map(ea).filter(e => e !== i).join(U))
            }
                ...
                I = (e = _, t = {}) => {
                    switch (t.type) {
                        ...
                        case m: {
                            ...
                            return (0, i.getIn)(s, [n, r]) !== r && (s = v(s, r, u, n, o)), T(s, n, c, a, o)
                        }
                        case y: {
                            let {
                                elementId: n,
